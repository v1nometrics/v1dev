...
Sentimento linguístico, *stance* e o label do produto passaram a ser tratados como três classificações distintas, cada uma com versão e histórico próprios. Uma versão nova só chega ao usuário depois de um gate explícito de benchmark, canary e comparação com a versão anterior. Enquanto isso não acontece, o produto continua mostrando a versão já aprovada. O experimental fica de fora até provar que merece entrar.
