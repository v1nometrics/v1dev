...
4. **Vetorização**: Sentence Transformers
...
|---------|-------------|-------------------|
| Vetores | LLM generativo | Determinístico, auditável, custo menor |
| HNSW | Busca exata | Latência aceitável com recall > 0.95 |
| Batch diário | Streaming | Volume não justifica complexidade |

<Callout type="decision" title="Vetores vs LLM">
Optamos por vetores porque precisávamos de scores reproduzíveis e explicáveis. LLMs trariam variância indesejada.
</Callout>
...
1. **Regras são importantes**: vetores sozinhos não capturam todas as nuances do domínio
